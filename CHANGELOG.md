...
- Update dependencies in package.json - nuxt 4.5.2 ([9e28682](https://github.com/sfxcode/nuxt-ui-formkit/commit/9e28682))
...
- Rename examples to samples, add missing samples, fix links ([151e7e8](https://github.com/sfxcode/nuxt-ui-formkit/commit/151e7e8))

### 🏡 Chore

- Update dependencies ([6ae814b](https://github.com/sfxcode/nuxt-ui-formkit/commit/6ae814b))
...
[compare changes](https://github.com/sfxcode/nuxt-ui-formkit/compare/v1.2.8...v1.2.9)

### 🚀 Enhancements

- Add Progress, Rating, User, and Badge output components ([042a9b5](https://github.com/sfxcode/nuxt-ui-formkit/commit/042a9b5))

### 🩹 Fixes

- Use Nuxt UI semantic tokens in output components for dark mode ([123154b](https://github.com/sfxcode/nuxt-ui-formkit/commit/123154b))
...
- Add nuxtUIInputRating/FUInputRating.vue for star-based rating input ([12fd5cb](https://github.com/sfxcode/nuxt-ui-formkit/commit/12fd5cb))

### 🏡 Chore

- Update dependencies to latest versions ([6ea834d](https://github.com/sfxcode/nuxt-ui-formkit/commit/6ea834d))
...
- Add Standard Schema validation bridge for FormKit forms ([869d39e](https://github.com/sfxcode/nuxt-ui-formkit/commit/869d39e))
