...
import { nuxtUIInputNumberDefinition } from '../../../src/runtime/formkit/definitions/input'
...
describe('FUInputNumber ui prop', () => {
  it('forwards a custom ui value onto the rendered base element, unlike before this fix (context.ui collision)', async () => {
    const wrapper = await mountSuspended(FormKit, {
      ...
      global: {
        plugins: [[plugin, defaultConfig({ inputs: { nuxtUIInputNumber: nuxtUIInputNumberDefinition } })]],
      },
    })
