...
import type { AutoFormOverrides, ValibotLikeSchema } from '../composables/useFormKitAutoForm'
import { ref, watch } from 'vue'
import { inferFormSchema, inferFormSchemaFromValibot } from '../composables/useFormKitAutoForm'
...
// data/overrides/valibotSchema references change, never on keystroke
// mutations - a rebuilt schema array would re-render FormKitSchema and drop
// input focus.
const formSchema = ref<FormKitSchemaNode[]>(buildSchema(props.data))

watch([() => props.data, () => props.overrides, () => props.valibotSchema], ([data]) => {
