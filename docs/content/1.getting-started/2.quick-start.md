---
title: Quick Start
description: Learn the basics of Nuxt UI FormKit using schema-based forms and create your first form in minutes.
---
...
**Best Practice:** Use schemas for most forms. Reserve template-based approach for simple cases or when you need fine-grained control over layout.
::
