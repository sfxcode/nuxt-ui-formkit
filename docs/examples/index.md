...
<CardGrid>
  <Card title="Playground" icon="i-lucide-github" to="https://github.com/sfxcode/nuxt-ui-formkit/tree/main/playground/app/pages" target="_blank">
    Browse all examples in the repository
  </Card>

  <Card title="Components" icon="i-lucide-book" to="/components/inputs">
    Learn about individual components
  </Card>

  <Card title="Schema Forms" icon="i-lucide-file-json" to="/getting-started/schema-forms">
